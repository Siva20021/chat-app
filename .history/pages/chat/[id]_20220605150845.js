  ...
  return (
    <Flex h="100vh">
        ...
        >
            ...
            <Flex
                flex={1}
                direction="column" w="fit-content" min-width="100px" borderRadius="lg" p={3} m={1}
            >
               <Flex bg="blue.100" w="fit-content" min-width="100px" borderRadius="lg" p={3} m={1}>
                    <Text>This is a dummy message</Text>
               </Flex>
               <Flex bg="blue.100" w="fit-content" min-width="100px" borderRadius="lg" p={3} m={1}>
                    <Text>This is a dummy message</Text>
               </Flex>
               <Flex bg="greem.100" w="fit-content" min-width="100px" borderRadius="lg" p={3} m={1} alignSelf="flex-end">
